...
/**
* translator class with MySQL 5 as a backend
...
class I18NtranslatorMySQL5 extends I18NtranslatorBase implements I18NtranslatorInterface {
	...
	*/
	...
	protected $database = 'translator_test';
	...
	protected function getConn() {
		if (!isset($this->conn)) {
			$this->conn = new mysqli($this->host, $this->user, $this->pw, $this->database);
 			$result = $this->conn->query('SET CHARACTER SET utf8');
	...
	*/
	protected function setLocales() {
		$this->locales = array();
		$result = $this->getConn()->query('CALL getLocales ()');
	...
	* @uses I18NtranslatorMySQL5::$use_filecache
	...
	* @uses I18NtranslatorMySQL5::fetchAllTranslations()
	...
	* @uses I18NtranslatorMySQL5::getTranslationTable()
	* @uses I18NtranslatorMySQL5::$translation_table
	* @uses I18NtranslatorMySQL5::getConn()
