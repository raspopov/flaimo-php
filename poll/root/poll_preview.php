...
define('TEMPLATE_PATH', '/networld_classes/poll/root/templates/s_templates/');
define('IMAGES_PATH', '/networld_classes/poll/root/images/');
define('INACTIVE_SUFIX', 'inactive');

require_once '../inc/class_PollBase_inc.php';
require_once '../smarty/class_PollSmarty_inc.php';
...
$smarty->display($template_path . '/' . $template_file);
die();
?>