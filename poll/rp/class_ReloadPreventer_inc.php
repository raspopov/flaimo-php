...
class ReloadPreventer {
	...
	*/
	public function setTokenSession() {
		if ($this->new_token_set == FALSE) {
			session_register(ReloadPreventer::SESSIONNAME);
			$this->setToken(md5(microtime()));
			$_SESSION[ReloadPreventer::SESSIONNAME] = (string) $this->token;
			$this->new_token_set = TRUE;
		} // end if
	} // end function
	...
	*/
	public function &getFormName() {
		return ReloadPreventer::FORMNAME;
	} // end function
	...
	*/
	public function getInputElement() {
		$this->setTokenSession();
		return (string) '<input name="' . ReloadPreventer::FORMNAME . '" type="hidden" value="' . $this->token . '" />';
	} // end function
	...
	*/
	public function isValid() {
		if (!isset($_POST[ReloadPreventer::FORMNAME]) || !isset($_SESSION[ReloadPreventer::SESSIONNAME])) {
			return (boolean) FALSE;
		} else {
			return (boolean) (($_POST[ReloadPreventer::FORMNAME] != $_SESSION[ReloadPreventer::SESSIONNAME]) ? FALSE : TRUE);
		} // end if
	} // end function
